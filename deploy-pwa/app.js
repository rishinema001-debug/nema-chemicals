...
(() => {
  ...
  function renderProducts() {
    ...
    if (state.activeBrand) {
      ...
      productGridEl.innerHTML = filtered.map((product, i) => renderProductCardHTML(product, i, t, badgeMap)).join('');
    }
  ...
  function handlePrintCatalog() {
    ...
    const html = `
      ...
      <body>
        <div class="print-header">
          <div>
            ...
            <div class="print-logo-sub">FMCG Price List (MRP)</div>
          </div>
        ...
        <div class="print-footer">
          Prices shown are Maximum Retail Prices (MRP). For bulk orders, please contact our sales office.
        </div>
          @media print {
            body { padding: 15px; }
            .no-print { display: none !important; }
      ...
      <body>
        ...
        <div class="print-footer">
          © ${new Date().getFullYear()} NEMA Chemicals — FMCG Distribution. All prices are MRP. Contact for bulk discounts.
        </div>
